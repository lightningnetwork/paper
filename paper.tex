...
petabytes per year. Clearly, that isn't feasible today. No home computer in the
...
For example, if a parent transaction is spent by a child with a nSequence value
of 10, if there have been 10 blocks and one of them has the 
...
\begin{itemize}
	...
	\item Micropayments. Bitcoin blockchain fees are far too high to accept
		...
		paying per-megative for internet service or per-article to read
		a newspaper.
